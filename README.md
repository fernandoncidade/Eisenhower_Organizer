...
> **Observação:** Este repositório refere-se à versão **v0.1.2.0** do Projeto EISENHOWER ORGANIZER. Apoie o projeto e adquira a versão paga através do link: [Instalar via Microsoft Store](https://apps.microsoft.com/detail/9P289X0185C3)
...
> **Note:** This repository refers to the **v0.1.2.0** version of the EISENHOWER ORGANIZER Project. Support the project and purchase the paid version through the link: [Install via Microsoft Store](https://apps.microsoft.com/detail/9P289X0185C3)
